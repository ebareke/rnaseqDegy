...
DEG <- DEG +
annotate("text", x = -2, y = 57, label = paste('Down = ', sum(keyvals == 'dodgerblue2')), hjust = 1, vjust = 0, family = "sans", size = 4, color = "dodgerblue2", fontface = "bold") +
annotate("text", x = 2, y = 57, label = paste('Up = ', sum(keyvals == 'firebrick2')), hjust = 0, vjust = 0, family = "sans", size = 4, color = "firebrick2", fontface = "bold")
