...
outputPath <- file.path(filePath, "deaFiles")
...
names(keyvals)[keyvals == 'grey'] <- 'No-signif-change'
...
DEG <- DEG +
annotate("text", x = -2, y = 145, label = paste('Down = ', sum(keyvals == 'dodgerblue2')), hjust = 1, vjust = 0, family = "sans", size = 4, color = "dodgerblue2", fontface = "bold") +
annotate("text", x = 2, y = 145, label = paste('Up = ', sum(keyvals == 'firebrick2')), hjust = 0, vjust = 0, family = "sans", size = 4, color = "firebrick2", fontface = "bold")
...
if (num_significant > 0) {
  ...
  DEG0<- DEG0 +
  annotate("text", x = 2.02, y = 145, label = paste("Up :", num_upregulated), hjust = 0, vjust = 0, family = "sans", size = 4, color = "firebrick2", fontface = "bold") +
  annotate("text", x = -2.02, y = 145, label = paste("Down:", num_downregulated), hjust = 1, vjust = 0, family = "sans", size = 4, color = "dodgerblue2", fontface = "bold")
  #
